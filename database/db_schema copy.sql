...
CREATE DATABASE IF NOT EXISTS oneapp
...
-- FamilyBot Tables
CREATE TABLE IF NOT EXISTS familybot_card_details (
...
CREATE TABLE IF NOT EXISTS familybot_fully_used_cards (
  card_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS processing_card_details (
  card_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  server_ip VARCHAR(45) NULL,
  bot_type VARCHAR(50) NULL,
  date_time DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS input_emails (
  email_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  email VARCHAR(255) NULL,
  pass VARCHAR(255) NULL
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS processing_emails (
  email_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  server_ip VARCHAR(45) NULL,
  bot_type VARCHAR(50) NULL,
  date_time DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS familybot_first_names (
  name_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  firstnames VARCHAR(100) NULL
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS familybot_surnames (
  name_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS familybot_fake_details (
...
CREATE TABLE IF NOT EXISTS familybot_extracted_family_links (
...
CREATE TABLE IF NOT EXISTS familybot_failed_cards (
  card_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  server_ip VARCHAR(45) NULL,
  bot_type VARCHAR(50) NULL,
  date_time DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS familybot_card_usage_log (
...
CREATE TABLE IF NOT EXISTS cache_bins (
...
CREATE TABLE IF NOT EXISTS expired_family_links (
  link_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  server_ip VARCHAR(45) NULL,
  bot_type VARCHAR(50) NULL,
  date_time DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS processing_family_links (
  link_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  server_ip VARCHAR(45) NULL,
  bot_type VARCHAR(50) NULL,
  date_time DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS used_5_times_family_links (
  link_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  server_ip VARCHAR(45) NULL,
  bot_type VARCHAR(50) NULL,
  date_time DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS failed_smtp (
  email_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  server_ip VARCHAR(45) NULL,
  bot_type VARCHAR(50) NULL,
  date_time DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS processing_smtp_emails (
  email_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  server_ip VARCHAR(45) NULL,
  bot_type VARCHAR(50) NULL,
  date_time DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS sender_emails_setup_logs (
  log_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  server_ip VARCHAR(45) NULL,
  bot_type VARCHAR(50) NULL,
  email_acc VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS password_changer_accounts (
...
CREATE TABLE IF NOT EXISTS processing_password_changes (
